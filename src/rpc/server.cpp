...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BIB features */
        {"hibera", "listmasternodes", &listmasternodes, true },
        {"hibera", "getmasternodecount", &getmasternodecount, true },
        {"hibera", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"hibera", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"hibera", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"hibera", "masternodecurrent", &masternodecurrent, true },
        {"hibera", "startmasternode", &startmasternode, true },
        {"hibera", "createmasternodekey", &createmasternodekey, true },
        {"hibera", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"hibera", "listmasternodeconf", &listmasternodeconf, true },
        {"hibera", "getmasternodestatus", &getmasternodestatus, true },
        {"hibera", "getmasternodewinners", &getmasternodewinners, true },
        {"hibera", "getmasternodescores", &getmasternodescores, true },
        {"hibera", "preparebudget", &preparebudget, true },
        {"hibera", "submitbudget", &submitbudget, true },
        {"hibera", "mnbudgetvote", &mnbudgetvote, true },
        {"hibera", "getbudgetvotes", &getbudgetvotes, true },
        {"hibera", "getnextsuperblock", &getnextsuperblock, true },
        {"hibera", "getbudgetprojection", &getbudgetprojection, true },
        {"hibera", "getbudgetinfo", &getbudgetinfo, true },
        {"hibera", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"hibera", "mnfinalbudget", &mnfinalbudget, true },
        {"hibera", "checkbudgets", &checkbudgets, true },
        {"hibera", "mnsync", &mnsync, true },
        {"hibera", "spork", &spork, true },
        {"hibera", "getcollateral", &getcollateral, true},
...
{
    return "> hibera-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23619/\n";
}
